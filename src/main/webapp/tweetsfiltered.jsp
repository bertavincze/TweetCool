    ...
    <div class="content">
        <div class="container">
            ...
            <div class="containerhead">
                <div class="title"><a href="">Filtered Tweets</a></div>
            </div>
            <p>Found <c:out value="${filtered.getTweets().size()}"/> tweet(s) matching that criteria: </p>
            <c:choose>
                <c:when test="${filtered != null}">
                    <c:forEach var="tweet" items="${filtered.getTweets()}">
